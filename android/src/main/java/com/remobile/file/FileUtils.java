...
public class FileUtils extends CordovaPlugin {
    ...
    public FileUtils(ReactApplicationContext reactContext, Activity activity) {
        super(reactContext);
    ...
    @ReactMethod
    public void testSaveLocationExists(ReadableArray args, Callback success, Callback error) {
        String action = "testSaveLocationExists";
        try {
    ...
    @ReactMethod
    public void getFreeDiskSpace(ReadableArray args, Callback success, Callback error) {
        String action = "getFreeDiskSpace";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
    ...
    @ReactMethod
    public void testFileExists(ReadableArray args, Callback success, Callback error) {
        String action = "testFileExists";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
    ...
    @ReactMethod
    public void testDirectoryExists(ReadableArray args, Callback success, Callback error) {
        String action = "testDirectoryExists";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
    ...
    @ReactMethod
    public void readAsText(ReadableArray args, Callback success, Callback error) {
        String action = "readAsText";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
    ...
    @ReactMethod
    public void readAsDataURL(ReadableArray args, Callback success, Callback error) {
        String action = "readAsDataURL";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
    ...
    @ReactMethod
    public void readAsArrayBuffer(ReadableArray args, Callback success, Callback error) {
        String action = "readAsArrayBuffer";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
    ...
    @ReactMethod
    public void readAsBinaryString(ReadableArray args, Callback success, Callback error) {
        String action = "readAsBinaryString";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
    ...
    @ReactMethod
    public void write(ReadableArray args, Callback success, Callback error) {
        String action = "write";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
    ...
    @ReactMethod
    public void truncate(ReadableArray args, Callback success, Callback error) {
        String action = "truncate";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
    ...
    @ReactMethod
    public void requestAllFileSystems(ReadableArray args, Callback success, Callback error) {
        String action = "requestAllFileSystems";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
    ...
    @ReactMethod
    public void requestAllPaths(ReadableArray args, Callback success, Callback error) {
        String action = "requestAllPaths";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
    ...
    @ReactMethod
    public void requestFileSystem(ReadableArray args, Callback success, Callback error) {
        String action = "requestFileSystem";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
    ...
    @ReactMethod
    public void resolveLocalFileSystemURI(ReadableArray args, Callback success, Callback error) {
        String action = "resolveLocalFileSystemURI";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
    ...
    @ReactMethod
    public void getFileMetadata(ReadableArray args, Callback success, Callback error) {
        String action = "getFileMetadata";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
    ...
    @ReactMethod
    public void getParent(ReadableArray args, Callback success, Callback error) {
    ...
    @ReactMethod
    public void getDirectory(ReadableArray args, Callback success, Callback error) {
        String action = "getDirectory";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
    ...
    @ReactMethod
    public void getFile(ReadableArray args, Callback success, Callback error) {
    ...
    @ReactMethod
    public void removeRecursively(ReadableArray args, Callback success, Callback error) {
        String action = "removeRecursively";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
    ...
    @ReactMethod
    public void moveTo(ReadableArray args, Callback success, Callback error) {
    ...
    @ReactMethod
    public void copyTo(ReadableArray args, Callback success, Callback error) {
        String action = "copyTo";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
    ...
    @ReactMethod
    public void readEntries(ReadableArray args, Callback success, Callback error) {
        String action = "readEntries";
        try {
            this.execute(action, JsonConvert.reactToJSON(args), new CallbackContext(success, error));
        } catch (Exception ex) {
            FLog.e(LOG_TAG, "Unexpected error:" + ex.getMessage());
    ...
    protected String[] getExtraFileSystemsPreference(Activity activity) {
        String fileSystemsStr ="files,files-external,documents,sdcard,cache,cache-external,root";
            ...
            if (!installedFileSystems.contains(fsName)) {
                ...
                if (fsRoot != null) {
                    ...
                    if (newRoot.mkdirs() || newRoot.isDirectory()) {
                        registerFilesystem(new LocalFilesystem(fsName, this.getContext(), this.getResourceApi(), newRoot));
    ...
    public void initialize() {
    	...
    	if (this.configured) {
    		...
    		// per spec.
    		this.registerFilesystem(new LocalFilesystem("temporary", this.getContext(), this.getResourceApi(), tmpRootFile));
    		this.registerFilesystem(new LocalFilesystem("persistent", this.getContext(), this.getResourceApi(), persistentRootFile));
