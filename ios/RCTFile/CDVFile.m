...
static NSString* const kCDVFilesystemURLPrefix = @"cdvfile";
static NSString* const kCDVAssetsLibraryScheme = @"assets-library";
...
RCT_EXPORT_CORDOVA_METHOD(requestFileSystem);
RCT_EXPORT_CORDOVA_METHOD(requestAllPaths);
RCT_EXPORT_CORDOVA_METHOD(requestAllFileSystems);
RCT_EXPORT_CORDOVA_METHOD(resolveLocalFileSystemURI);
RCT_EXPORT_CORDOVA_METHOD(getDirectory);
RCT_EXPORT_CORDOVA_METHOD(getFile);
RCT_EXPORT_CORDOVA_METHOD(getParent);
RCT_EXPORT_CORDOVA_METHOD(removeRecursively);
RCT_EXPORT_CORDOVA_METHOD(remove);
RCT_EXPORT_CORDOVA_METHOD(copyTo);
RCT_EXPORT_CORDOVA_METHOD(moveTo);
RCT_EXPORT_CORDOVA_METHOD(getFileMetadata);
RCT_EXPORT_CORDOVA_METHOD(readEntries);
RCT_EXPORT_CORDOVA_METHOD(readAsText);
RCT_EXPORT_CORDOVA_METHOD(readAsDataURL);
RCT_EXPORT_CORDOVA_METHOD(readAsArrayBuffer);
RCT_EXPORT_CORDOVA_METHOD(write);
RCT_EXPORT_CORDOVA_METHOD(testFileExists);
RCT_EXPORT_CORDOVA_METHOD(testDirectoryExists);
RCT_EXPORT_CORDOVA_METHOD(getFreeDiskSpace);
RCT_EXPORT_CORDOVA_METHOD(truncate);
...
- (void)pluginInitialize
{
    ...
    [self registerExtraFileSystems:[self getExtraFileSystemsPreference:nil]
...
- (void)getDirectory:(CDVInvokedUrlCommand*)command
{
    ...
    CDVInvokedUrlCommand* subCommand = [[CDVInvokedUrlCommand alloc] initWithArguments:arguments command:command];
