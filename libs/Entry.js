        ...
        success = function (entry) {
            if (entry) {
                if (successCallback) {
                    ...
                    const result = (entry.isDirectory) ? new (require('./DirectoryEntry'))(entry.name, entry.fullPath, fs, entry.nativeURL) : new (require('./FileEntry'))(entry.name, entry.fullPath, fs, entry.nativeURL);
